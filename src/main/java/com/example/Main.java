...
//        System.out.println(vm.deleteVideo("lingyue", "bz.mp4"));
//
//        System.out.println("=======delete video list==========");
//        System.out.println(vm.deleteVideoList("lingyue", new String[]{"bz.mp4", "onepiece.mp4"}));
//
//        /********************transconf*************************/
...
//        audio.setQuality(50);
//        audio.setBit_rate("256k");
//        audio.setSample_rate("44100");
//        audio.setCodec_name("libfaac");
//
//
//        VideoInfo video = new VideoInfo();
//        video.setBit_rate("150k");
//        video.setWidth(1280);
//        video.setHeight(720);
//        video.setFrame_rate("24");
//        video.setCodec_name("libx264");
//
...
//        watermark.setOffset_x(1);
//        watermark.setOffset_y(2);
//        watermark.setImage("1.png");
//        watermark.setText("watermark");
//        watermark.setText_font("Consolas");
//        watermark.setText_color("#ffffff");
//        watermark.setText_size(12);
//
...
//        marquee.setDirection("North");
//        marquee.setEnabled(true);
//        marquee.setLoop(-1);
//        marquee.setDuration(2);
////        marquee.setImage("1.png");
//        marquee.setText("marquee");
//        marquee.setText_font("Consolas");
//        marquee.setText_color("#FF");
//        marquee.setText_size(12);
//
